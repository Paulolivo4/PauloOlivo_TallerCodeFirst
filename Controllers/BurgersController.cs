...
namespace PauloOlivo_TallerCodeFirst.Controllers
{
    public class BurgersController : Controller
    {
        private readonly PauloOlivo_TallerCodeFirstContext _context;

        public BurgersController(PauloOlivo_TallerCodeFirstContext context)
        {
            _context = context;
        }
